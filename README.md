...
## Task0. Sprite languages
With the html code and image provided, create css file to get the below layout

** Note: You are not allowed to change the image and the HTML
